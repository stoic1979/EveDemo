...
MONGO_USERNAME = os.environ.get('MONGO_USERNAME', '') #FIXME set username later
MONGO_PASSWORD = os.environ.get('MONGO_PASSWORD', '') #FIXME set password later
MONGO_DBNAME = os.environ.get('MONGO_DBNAME', 'evedemo')

# authentication database for mongodb
# by default it is None
# Refer Eve config - http://python-eve.org/config.html
